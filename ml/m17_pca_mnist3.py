#실습
#pca를 통해 0.99 이상인 n_components가 몇개>
#모델을 구성
...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, MaxPool2D, GlobalAveragePooling2D, Dropout, BatchNormalization

model = Sequential()
model.add(Dense(512, input_shape=(486,)))
