...
'''
best_params_ : {'validation_split': 0.2, 'node': 64, 'learning_rate': 0.001, 'epochs': 1, 'drop': 0.3, 'batch_size': 2000, 'activation': 'relu'}    
best_estimator_ : <tensorflow.python.keras.wrappers.scikit_learn.KerasClassifier object at 0x0000023306E2F730>
best_score_ : 0.9803920984268188
final_score : 0.9803921580314636
'''