...
W1 = tf.compat.v1.get_variable('w1', shape=[2,2,3,64])
...
W2 =tf.compat.v1.get_variable('w2', shape=[2 ,2 ,64 ,128])
...
W3 =tf.compat.v1.get_variable('w3', shape=[2 ,2 ,128 ,256])
...
W4 =tf.compat.v1.get_variable('w4', shape=[2 ,2 ,256 ,128],)
...
#Flatten 
L_flat =tf.reshape(L4_maxpool, [-1,2*2*128])
print("플레튼:",L_flat)


#L5 DNN

W5 = tf.compat.v1.get_variable('w5', shape=[2*2*128,128],)
#initializer = tf.contrib.layers.xavier_initializer())
...
W6 = tf.compat.v1.get_variable('w6', shape=[128,64],)
#initializer = tf.contrib.layers.xavier_initializer())
b6 = tf.Variable(tf.compat.v1.random_normal([64]), name='b2')
...
W7 = tf.compat.v1.get_variable('w7', shape=[64,10])
