...
from tensorflow.keras.layers import Dense, Embedding, Input, LSTM   # Embedding 자연어 쪽에서 많이 씀
...
em1 = LSTM(units = 32, activation='relu')(em1)
output1 = Dense(1)(em1)
