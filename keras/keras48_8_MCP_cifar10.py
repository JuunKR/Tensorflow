...
from tensorflow.keras.layers import Dense, Conv1D, Flatten, MaxPool2D, LSTM
...
cp = ModelCheckpoint(monitor='val_loss', save_best_only=True, mode='auto', 
                        filepath='./_save/ModelCheckPoint/keras48_8_cifar10_MCP.hdf5')

import time
start_time = time.time()
hist = model.fit(x_train,y_train, epochs=100, batch_size=32, validation_split=0.2, callbacks=[es,cp])
end_time = time.time() - start_time



model.save('./_save/ModelCheckPoint/keras48_8_cifar_model_save.h5')
