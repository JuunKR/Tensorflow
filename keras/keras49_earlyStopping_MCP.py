...
print('================================== 2. load_model2  =========================================================')
model2 = load_model('./_save/ModelChekPoint/keras47_model_save.h5')
