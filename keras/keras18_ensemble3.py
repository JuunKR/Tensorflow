...
x1_train, x1_test, y1_train, y1_test, y2_train, y2_test = train_test_split(x1, y1, y2, random_state=66, train_size=0.7) 
...
# output21 = Dense(7, name='output21')(merge1)
last_output1 = Dense(1, name='last_output1')(output1)

# output22 = Dense(7,  name='output22')(merge1)
last_output2 = Dense(1,name='last_output2')(output1)
...
# loss :  163.79983520507812
# marics :  101.79920196533203d
