...
cp = ModelCheckpoint(monitor='val_loss', save_best_only=True, mode='auto', 
                        filepath='./_save/ModelCheckPoint/keras48_3_diabets_MCP.hdf5')

model.fit(x_train,y_train, epochs=100, batch_size=4, verbose=1,
validation_split=0.25, callbacks=[es, cp])
model.save('./_save/ModelCheckPoint/keras48_3_diabets_model_save.h5')
# 평가, 예측
