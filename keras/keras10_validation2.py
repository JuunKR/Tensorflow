...
model.fit(x[:7], y[:7], epochs=1000, batch_size=1, validation_data=(x[-3:],y[-3:])) # loss가 통상적으로 좋다/ 과적합에 더 잘걸림 /valloss가 더 중요  


#4. 평가, 예측
loss = model.evaluate(x[-6:-3],y[-6:-3])
print('loss : ', loss)
...
# plt.scatter(x,y, c='blue', alpha=0.5)d
